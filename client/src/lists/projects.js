...
const projects = [
  {
    ...
    project_description:
      "This application allows you to book appointments with doctors in various fields, store your medical records, and monitor treatments. It's designed to securely store patients' medical data in one location, enabling registered doctors to easily access their records with permission.",
